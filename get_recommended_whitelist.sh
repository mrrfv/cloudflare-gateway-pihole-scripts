#!/bin/bash
#  
# Uncomment the provided list or add you own
# https://oisd.nl/includedlists/whitelists
# create an empty whitelist.csv file
touch whitelist.csv
...
echo "Done. The whitelist.csv file contains merged data from recommended whitelist."
